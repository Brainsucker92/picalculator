...
public class BaileyBorweinPlouffeCalculator extends PiCalculatorImpl {
    ...
    private CompletableFuture<BigDecimal> calculateBBP(int k, MathContext context) {
        ...
        CompletableFuture<BigDecimal> t1Future =
        ...
        CompletableFuture<BigDecimal> t2Future =
                CompletableFuture.supplyAsync(() -> BigDecimal.valueOf(4)
                                                              .divide(BigDecimal.valueOf(8 * k + 1), context), service);
        CompletableFuture<BigDecimal> t3Future =
                CompletableFuture.supplyAsync(() -> BigDecimal.valueOf(2)
                                                              .divide(BigDecimal.valueOf(8 * k + 4), context), service);
        CompletableFuture<BigDecimal> t4Future =
                CompletableFuture.supplyAsync(() -> BigDecimal.valueOf(1)
                                                              .divide(BigDecimal.valueOf(8 * k + 5), context), service);
        CompletableFuture<BigDecimal> t5Future =
                CompletableFuture.supplyAsync(() -> BigDecimal.valueOf(1)
        ...
        CompletableFuture<BigDecimal> future = t1Future.thenCombine(diffFuture, BigDecimal::multiply).thenApply(BigDecimal::stripTrailingZeros);
